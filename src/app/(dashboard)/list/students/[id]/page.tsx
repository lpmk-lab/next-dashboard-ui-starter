    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col  lg:flex-row gap-4">
          ...
          <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex-col justify-between gap-4">
              <h1 className="text-xl font-semibold">Tha Zin Myint </h1>
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                ...
                <div className="w-full md:w-1/3 2xl:w-1/3  lg:w-full flex items-center gap-2">
                  ...
                  <span>lapyaeminkhant.cb@gmail.com</span>
                </div>
                <div className="w-full md:w-1/3 2xl:w-1/3  lg:w-full flex items-center gap-2">
                  <Image src="/phone.png" alt="" width={14} height={14} />
                  <span>09768005498</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-4 bg-white rounded-md p-4 h-[800px]">
          ...
          <BigCalendarContainer type="classId" id="213213213" />
        </div>
      </div>
      {/* Right */}
